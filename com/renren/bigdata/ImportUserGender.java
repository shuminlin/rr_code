 ...
 */
public class ImportUserGender {



    public static void main(String[] args) throws Exception{
        String INPUT_FILE = "/Users/zyshen/t_sex_true";
        ...
        while ((line = reader.readLine()) != null) {
            ...
            //construct
                ...
                put.add(Bytes.toBytes("l"),Bytes.toBytes(gender),Bytes.toBytes("1"));
